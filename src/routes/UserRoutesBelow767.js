...
const UserRoutesBelow767 = () => (

    <Route path="/user/:id" element={<ProductOrUserDetailsBelow767 />}>
      ...
      {/* user wallet */}
      <Route path="wallet" element={<UserWalletBelow767 />} />
...
export default UserRoutesBelow767;
