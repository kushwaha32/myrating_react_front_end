...
import RateAsUserType from "./RateAsUser";
...
import { useCreateRatingMutation } from "../slices/ratingApiSlice";
...
const RatingAndReview = ({ location }) => {
  ...
  const handleAvgRating = useAvgRatingWithSocket(location[2]);

  ////////////////////////////////////////////////////////////////////////////////////////
  ////////////////////////// --- update the Rating distribution  ----- ////////////////////
  ////////////////////////////////////////////////////////////////////////////////////////
  const handleRatingDistribution = useRatingDistributionWithSocket(location[2]);
