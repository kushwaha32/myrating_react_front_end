...
const ProductOtherInformation = () => {
      ...
      try {
        ...
        const hoursOfOperation = {
          ...
          operationDay: {
            monday: {
              start:
                values.isHoursOpenPublic === "yes" ? values.mondayStart : "",
              end: values.isHoursOpenPublic === "yes" ? values.mondayEnd : "",
              close:
                values.isHoursOpenPublic === "yes" ? values.mondayClose : "",
            },
            tuesday: {
              start:
                values.isHoursOpenPublic === "yes" ? values.tuesdayStart : "",
              end: values.isHoursOpenPublic === "yes" ? values.tuesdayEnd : "",
              close:
                values.isHoursOpenPublic === "yes" ? values.tuesdayClose : "",
            },
            wednesday: {
              start:
                values.isHoursOpenPublic === "yes" ? values.wednesdayStart : "",
              end:
                values.isHoursOpenPublic === "yes" ? values.wednesdayEnd : "",
              close:
                values.isHoursOpenPublic === "yes" ? values.wednesdayClose : "",
            },
            thursday: {
              start:
                values.isHoursOpenPublic === "yes" ? values.thursdayStart : "",
              end: values.isHoursOpenPublic === "yes" ? values.thursdayEnd : "",
              close:
                values.isHoursOpenPublic === "yes" ? values.thursdayClose : "",
            },
            friday: {
              start:
                values.isHoursOpenPublic === "yes" ? values.fridayStart : "",
              end: values.isHoursOpenPublic === "yes" ? values.fridayEnd : "",
              close:
                values.isHoursOpenPublic === "yes" ? values.fridayClose : "",
            },
            saturday: {
              start:
                values.isHoursOpenPublic === "yes" ? values.saturdayStart : "",
              end: values.isHoursOpenPublic === "yes" ? values.saturdayEnd : "",
              close:
                values.isHoursOpenPublic === "yes" ? values.saturdayClose : "",
            },
            sunday: {
              start:
                values.isHoursOpenPublic === "yes" ? values.sundayStart : "",
              end: values.isHoursOpenPublic === "yes" ? values.sundayEnd : "",
              close:
                values.isHoursOpenPublic === "yes" ? values.sundayClose : "",
            },
          },
        };
        ...
        localStorage.setItem("proOtherInformation", JSON.stringify(data));
        handlePreviousStep("other-information");
        setIsLoading(false);
        navigate(
          `/business/${location[2]}/listed-profile/create-profile/profile-keyboards`
        );
      } catch (error) {
        console.log(error);
        setIsLoading(false);
  ...
  useEffect(() => {
    const preOtherInfo = JSON.parse(
      localStorage.getItem("proOtherInformation")
    );
    console.log(preOtherInfo);
    setFieldValue("description", preOtherInfo?.description);

    ////////////////////////////////////////////////////////////////
    /////////////////--- Offers prefilling ---/////////////////////
    //////////////////////////////////////////////////////////////
    const offers = preOtherInfo?.offer?.map((currOffer) => currOffer.offer);
    const offerValidUpto = preOtherInfo?.offer?.map(
      (currOffer) => currOffer?.offerValidUpto
    );
    const isOfferPublic = preOtherInfo?.offer?.map(
      (currOffer) => !currOffer?.isOfferPublic
    );
    setFieldValue("offer", offers || [""]);
    setFieldValue("offerValidUpto", offerValidUpto || [""]);
    setFieldValue("isOfferPublic", isOfferPublic || [true]);

    ////////////////////////////////////////////////////////////////
    ///////////--- stablishment year prefilling ---////////////////
    //////////////////////////////////////////////////////////////
    setFieldValue(
      "stablismentYear",
      preOtherInfo?.stablishmentYear?.year || ""
    );
    setFieldValue(
      "isStablismentYearPublic",
      preOtherInfo?.stablishmentYear?.isStablismentYearPublic || false
    );

    /////////////////////////////////////////////////////////////////////
    ///////////////--- award, sertificate, recognition ---//////////////
    ///////////////////////////////////////////////////////////////////
    const awardCerRecong = preOtherInfo?.awardCerRecognition?.map(
      (currAward) => currAward?.awardCerRecognition
    );

    const awardCerRecognitionYear = preOtherInfo?.awardCerRecognition?.map(
      (currAward) => currAward?.year
    );

    const isAwardCerRecognitionPublic = preOtherInfo?.awardCerRecognition?.map(
      (currAward) => currAward?.isAwardCerRecognitionPublic
    );
    setFieldValue("awardCerRecognition", awardCerRecong || [""]);
    setFieldValue("awardCerRecognitionYear", awardCerRecognitionYear || [""]);
    setFieldValue(
      "isAwardCerRecognitionPublic",
      isAwardCerRecognitionPublic || [false]
    );

    /////////////////////////////////////////////////////////////////////
    ///////////////--- Hours of operation for visitor ---///////////////
    ///////////////////////////////////////////////////////////////////
    if (preOtherInfo?.hoursOfOperation?.isHoursOpenPublic) {
      setFieldValue("isHoursOpenPublic", "yes");

      ///////////////////////////////////////////////////////////////
      //////////////---- Monday operation hours ----////////////////
      /////////////////////////////////////////////////////////////
      setFieldValue(
        "mondayStart",
        preOtherInfo?.hoursOfOperation?.operationDay?.monday?.start
      );
      setFieldValue(
        "mondayEnd",
        preOtherInfo?.hoursOfOperation?.operationDay?.monday?.end
      );
      setFieldValue(
        "mondayClose",
        preOtherInfo?.hoursOfOperation?.operationDay?.monday?.close
      );

      ///////////////////////////////////////////////////////////////
      //////////////---- Tuesday operation hours ----////////////////
      /////////////////////////////////////////////////////////////
      setFieldValue(
        "tuesdayStart",
        preOtherInfo?.hoursOfOperation?.operationDay?.tuesday?.start
      );
      setFieldValue(
        "tuesdayEnd",
        preOtherInfo?.hoursOfOperation?.operationDay?.tuesday?.end
      );
      setFieldValue(
        "tuesdayClose",
        preOtherInfo?.hoursOfOperation?.operationDay?.tuesday?.close
      );

      ///////////////////////////////////////////////////////////////
      //////////////---- Wednesday operation hours ----////////////////
      /////////////////////////////////////////////////////////////
      setFieldValue(
        "wednesdayStart",
        preOtherInfo?.hoursOfOperation?.operationDay?.wednesday?.start
      );
      setFieldValue(
        "wednesdayEnd",
        preOtherInfo?.hoursOfOperation?.operationDay?.wednesday?.end
      );
      setFieldValue(
        "wednesdayClose",
        preOtherInfo?.hoursOfOperation?.operationDay?.wednesday?.close
      );

      ///////////////////////////////////////////////////////////////
      //////////////---- Thursday operation hours ----////////////////
      /////////////////////////////////////////////////////////////
      setFieldValue(
        "thursdayStart",
        preOtherInfo?.hoursOfOperation?.operationDay?.thursday?.start
      );
      setFieldValue(
        "thursdayEnd",
        preOtherInfo?.hoursOfOperation?.operationDay?.thursday?.end
      );
      setFieldValue(
        "thursdayClose",
        preOtherInfo?.hoursOfOperation?.operationDay?.thursday?.close
      );

      ///////////////////////////////////////////////////////////////
      //////////////---- Friday operation hours ----////////////////
      /////////////////////////////////////////////////////////////
      setFieldValue(
        "fridayStart",
        preOtherInfo?.hoursOfOperation?.operationDay?.friday?.start
      );
      setFieldValue(
        "fridayEnd",
        preOtherInfo?.hoursOfOperation?.operationDay?.friday?.end
      );
      setFieldValue(
        "fridayClose",
        preOtherInfo?.hoursOfOperation?.operationDay?.friday?.close
      );

      ///////////////////////////////////////////////////////////////
      //////////////---- Saturday operation hours ----////////////////
      /////////////////////////////////////////////////////////////
      setFieldValue(
        "saturdayStart",
        preOtherInfo?.hoursOfOperation?.operationDay?.saturday?.start
      );
      setFieldValue(
        "saturdayEnd",
        preOtherInfo?.hoursOfOperation?.operationDay?.saturday?.end
      );
      setFieldValue(
        "saturdayClose",
        preOtherInfo?.hoursOfOperation?.operationDay?.saturday?.close
      );

      ///////////////////////////////////////////////////////////////
      //////////////---- Sunday operation hours ----////////////////
      /////////////////////////////////////////////////////////////
      setFieldValue(
        "sundayStart",
        preOtherInfo?.hoursOfOperation?.operationDay?.sunday?.start
      );
      setFieldValue(
        "sundayEnd",
        preOtherInfo?.hoursOfOperation?.operationDay?.sunday?.end
      );
      setFieldValue(
        "sundayClose",
        preOtherInfo?.hoursOfOperation?.operationDay?.sunday?.close
      );
    } else {
      setFieldValue("isHoursOpenPublic", "no");
    }

    /////////////////////////////////////////////////////////////////////
    ///////////////--- Hours of operation for visitor ---///////////////
    ///////////////////////////////////////////////////////////////////
    if (preOtherInfo?.pamentModes?.isPamentModesPublic) {
      setFieldValue("isPamentModesPublic", "yes");
      setFieldValue(
        "cash",
        preOtherInfo?.pamentModes?.pamentModesOptions?.cash
      );
      setFieldValue(
        "debitCards",
        preOtherInfo?.pamentModes?.pamentModesOptions?.debitCards
      );
      setFieldValue(
        "creditCards",
        preOtherInfo?.pamentModes?.pamentModesOptions?.creditCards
      );
      setFieldValue(
        "americonExpressCards",
        preOtherInfo?.pamentModes?.pamentModesOptions?.americonExpressCards
      );
      setFieldValue(
        "checkDD",
        preOtherInfo?.pamentModes?.pamentModesOptions?.checkDD
      );
      setFieldValue(
        "rtgsNeftImps",
        preOtherInfo?.pamentModes?.pamentModesOptions?.rtgsNeftImps
      );
      setFieldValue("upi", preOtherInfo?.pamentModes?.pamentModesOptions?.upi);
      setFieldValue(
        "gPay",
        preOtherInfo?.pamentModes?.pamentModesOptions?.gPay
      );
      setFieldValue(
        "phonePay",
        preOtherInfo?.pamentModes?.pamentModesOptions?.phonePay
      );
      setFieldValue(
        "payTm",
        preOtherInfo?.pamentModes?.pamentModesOptions?.payTm
      );
      setFieldValue(
        "amazonPay",
        preOtherInfo?.pamentModes?.pamentModesOptions?.amazonPay
      );
      setFieldValue(
        "credPay",
        preOtherInfo?.pamentModes?.pamentModesOptions?.credPay
      );
      setFieldValue(
        "airtelMoney",
        preOtherInfo?.pamentModes?.pamentModesOptions?.airtelMoney
      );
      setFieldValue(
        "bhimApp",
        preOtherInfo?.pamentModes?.pamentModesOptions?.bhimApp
      );
      setFieldValue(
        "cashOnDelivery",
        preOtherInfo?.pamentModes?.pamentModesOptions?.cashOnDelivery
      );
      setFieldValue(
        "jioPay",
        preOtherInfo?.pamentModes?.pamentModesOptions?.jioPay
      );
      setFieldValue(
        "masterCard",
        preOtherInfo?.pamentModes?.pamentModesOptions?.masterCard
      );
      setFieldValue(
        "visaCard",
        preOtherInfo?.pamentModes?.pamentModesOptions?.visaCard
      );
      setFieldValue(
        "rupayCard",
        preOtherInfo?.pamentModes?.pamentModesOptions?.rupayCard
      );
      setFieldValue(
        "moneyOrder",
        preOtherInfo?.pamentModes?.pamentModesOptions?.moneyOrder
      );
      setFieldValue(
        "travellersCard",
        preOtherInfo?.pamentModes?.pamentModesOptions?.travellersCard
      );
      setFieldValue(
        "payuMoney",
        preOtherInfo?.pamentModes?.pamentModesOptions?.payuMoney
      );
    } else {
      setFieldValue("isPamentModesPublic", "no");
    }
  }, []);
        ...
        <div className="form-group">
              ...
              <div className="col-lg-6 d-flex align-items-center">
                ...
                >
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <ToggledSwitch publicStatus={values?.isOfferPublic[index]} />
                </div>
              </div>
            </div>
          ))}
            ...
            <div className="col-lg-9 d-flex align-items-center justify-content-between">
              ...
              >
                <input
                  ...
                  onChange={handleChange}
                />
                <ToggledSwitch publicStatus={values?.isStablismentYearPublic} />
              </div>
            </div>
          </div>
          ...
          <div className="row mt-4 gender-chek hours-operation">
            ...
            <div className="col-lg-12">
              ...
              {values?.isPamentModesPublic === "yes" && (
...
export default ProductOtherInformation;
